...
Based on the MetaExpert Constitution v1.2.0, the following gates must be checked:
...
6. Unified Logging System: All modules must integrate with the centralized logging system located at `src/metaexpert/logger` with consistent structured logging.
