...
**Branch**: `qwen-feature/[###-feature-name]` | **Date**: [DATE] | **Spec**: [link]
**Input**: Feature specification from `/specs/qwen-feature/[###-feature-name]/spec.md`
