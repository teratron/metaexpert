...
class SafeFileHandler(logging.FileHandler):
    ...
    def __init__(self, filename, mode='a', encoding=None, delay=False, min_free_space_mb=10):
    ...
    def emit(self, record):
        ...
        if not check_disk_space(self.baseFilename, required_space_mb=self.min_free_space_mb):
...
class DiskSpaceMonitoringFileHandler(logging.FileHandler):
    ...
    def __init__(self, filename, console_handler=None, mode='a', encoding=None, delay=False, 
    ...
    def emit(self, record):
        ...
        if not self._using_console_only:
            if not check_disk_space(self.baseFilename, required_space_mb=self.low_space_threshold_mb):
