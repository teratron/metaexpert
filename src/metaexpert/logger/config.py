...
LOG_MAX_SIZE: int = int(str(os.getenv("LOG_MAX_SIZE")))  # Maximum log file size (10*1024*1024 = 10MB)
LOG_BACKUP_COUNT: int = int(str(os.getenv("LOG_BACKUP_COUNT")))  # Number of backup log files
